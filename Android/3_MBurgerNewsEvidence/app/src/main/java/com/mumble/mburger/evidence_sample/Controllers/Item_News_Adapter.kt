...
import com.mumble.mburger.evidence_sample.Activities.Act_detail
import com.mumble.mburger.evidence_sample.Data.News
import com.mumble.mburger.evidence_sample.R
import java.text.SimpleDateFormat

class Item_News_Adapter(val act: Activity, val items: ArrayList<News>?, val evidenceSectionId: Long) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var evidenceRound: View = itemView.findViewById(R.id.item_news_evidence_round)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ViewHolder) {
            ...
            if (item.section_id == evidenceSectionId) {
                holder.evidenceRound.visibility = View.VISIBLE
            } else {
                holder.evidenceRound.visibility = View.GONE
            }
